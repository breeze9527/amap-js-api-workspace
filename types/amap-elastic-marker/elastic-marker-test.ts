...
elasticMarker.on('click', (event: AMap.ElasticMarker.EventMap<typeof elasticMarker>['click']) => {
    // $ExpectType "click"
    event.type;
    // $ExpectType ElasticMarker<ExtraData>
    event.target;
...
elasticMarker.on('allLoaded', (event: AMap.ElasticMarker.EventMap<typeof elasticMarker>['allLoaded']) => {
