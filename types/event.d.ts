...
type ReferEventMap<I extends AMap.EventEmitter> =
    ...
    I extends OmitEventEmitter<AMap.AdvancedInfoWindow> ? AMap.AdvancedInfoWindowEventMap<I> :
    I extends OmitEventEmitter<AMap.InfoWindow> ? AMap.InfoWindowEventMap<I> :
    ...
    I extends OmitEventEmitter<AMap.PlaceSearchLayer> ? AMap.PlaceSearchLayerEventMap :
    I extends OmitEventEmitter<AMap.LineSearch> ? AMap.LineSearchEventMap :
    any;
