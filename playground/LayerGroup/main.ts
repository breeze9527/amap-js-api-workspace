...
var tileLayer1 = new AMap.TileLayer();
var tileLayer2 = new AMap.TileLayer();
var tileLayer3 = new AMap.TileLayer();

test('LayerGroup(layer)', new AMap.LayerGroup(tileLayer1));
test('LayerGroup(layer[])', new AMap.LayerGroup([tileLayer2]));

var layerGroup = new AMap.LayerGroup<AMap.TileLayer>(tileLayer1);
